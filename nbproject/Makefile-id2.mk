...
ifeq "$(wildcard nbproject/Makefile-local-id2.mk)" "nbproject/Makefile-local-id2.mk"
include nbproject/Makefile-local-id2.mk
endif
endif
...
SOURCEFILES_QUOTED_IF_SPACED=mcos/chips/pic16f688/pic16f688_interrupt.c mcos/chips/pic16f688/pic16f688_uart.c mcos/chips/pic16f688/board_manager_generic.c mcos/application.c main.c id_2.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/mcos/chips/pic16f688/pic16f688_interrupt.p1 ${OBJECTDIR}/mcos/chips/pic16f688/pic16f688_uart.p1 ${OBJECTDIR}/mcos/chips/pic16f688/board_manager_generic.p1 ${OBJECTDIR}/mcos/application.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/id_2.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/mcos/chips/pic16f688/pic16f688_interrupt.p1.d ${OBJECTDIR}/mcos/chips/pic16f688/pic16f688_uart.p1.d ${OBJECTDIR}/mcos/chips/pic16f688/board_manager_generic.p1.d ${OBJECTDIR}/mcos/application.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/id_2.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/mcos/chips/pic16f688/pic16f688_interrupt.p1 ${OBJECTDIR}/mcos/chips/pic16f688/pic16f688_uart.p1 ${OBJECTDIR}/mcos/chips/pic16f688/board_manager_generic.p1 ${OBJECTDIR}/mcos/application.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/id_2.p1

# Source Files
SOURCEFILES=mcos/chips/pic16f688/pic16f688_interrupt.c mcos/chips/pic16f688/pic16f688_uart.c mcos/chips/pic16f688/board_manager_generic.c mcos/application.c main.c id_2.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-id2.mk dist/${CND_CONF}/${IMAGE_TYPE}/NFC-bluetooth.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/id_2.p1: id_2.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/id_2.p1.d 
	@${RM} ${OBJECTDIR}/id_2.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=none    --double=24 --float=24 --opt=+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=pro -P -N255 --warn=-3 --asmlist -DXPRJ_id2=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/id_2.p1 id_2.c 
	@-${MV} ${OBJECTDIR}/id_2.d ${OBJECTDIR}/id_2.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/id_2.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
${OBJECTDIR}/mcos/chips/pic16f688/pic16f688_interrupt.p1: mcos/chips/pic16f688/pic16f688_interrupt.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/mcos/chips/pic16f688/pic16f688_interrupt.p1.d 
	@${RM} ${OBJECTDIR}/mcos/chips/pic16f688/pic16f688_interrupt.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G    --double=24 --float=24 --opt=+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=pro -P -N255 --warn=-3 --asmlist -DXPRJ_id2=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/mcos/chips/pic16f688/pic16f688_interrupt.p1 mcos/chips/pic16f688/pic16f688_interrupt.c 
	@-${MV} ${OBJECTDIR}/mcos/chips/pic16f688/pic16f688_interrupt.d ${OBJECTDIR}/mcos/chips/pic16f688/pic16f688_interrupt.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/mcos/chips/pic16f688/pic16f688_interrupt.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
dist/${CND_CONF}/${IMAGE_TYPE}/NFC-bluetooth.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  mcos/mcfifo.lpp mcos/mceeprom.lpp mcos/mcuart.lpp  
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/NFC-bluetooth.X.${IMAGE_TYPE}.map  -D__DEBUG=1  --debugger=none  -DXPRJ_id2=$(CND_CONF)    --double=24 --float=24 --opt=+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=pro -P -N255 --warn=-3 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/NFC-bluetooth.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}    mcos/mcfifo.lpp mcos/mceeprom.lpp mcos/mcuart.lpp 
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/NFC-bluetooth.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/NFC-bluetooth.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  mcos/mcfifo.lpp mcos/mceeprom.lpp mcos/mcuart.lpp 
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/NFC-bluetooth.X.${IMAGE_TYPE}.map  -DXPRJ_id2=$(CND_CONF)    --double=24 --float=24 --opt=+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=pro -P -N255 --warn=-3 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/NFC-bluetooth.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}    mcos/mcfifo.lpp mcos/mceeprom.lpp mcos/mcuart.lpp 
